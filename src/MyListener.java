	...
	public void contextInitialized(ServletContextEvent arg0) {
      ...
      try{
       ...
       if(status==0)
		...
		PreparedStatement ps=con.prepareStatement("CREATE TABLE CUSTOMER(CID NUMBER,FNAME VARCHAR2(25),LNAME VARCHAR2(25),USERNAME VARCHAR2(4000),PASSWORD VARCHAR2(4000),EMAIL VARCHAR2(4000),ADDERESS VARCHAR2(4000),CONTACT NUMBER,AADHARNO VARCHAR2(12),GENDER VARCHAR2(2),ISADMIN BOOLEAN,PRIMARY KEY (CID)) ");
		ps.executeUpdate();
